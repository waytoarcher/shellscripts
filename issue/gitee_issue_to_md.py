...
if __name__ == '__main__':
    ...
    parser.add_argument('-u', '--username', help="gitee account username")
    parser.add_argument('-r', '--repo', help="gitee account repo")
    parser.add_argument('-t', '--token', help="gitee personal access token")
    ...
    issue_url = "https://gitee.com/api/v5/repos/%s/%s/issues" % (
        args.username, args.repo)

    ret = get_info(issue_url, args.token)
